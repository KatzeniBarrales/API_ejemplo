...
const ModalActions = ({open,onCloseModal,getEmployees}) => {
    const initialState={
        nombres:"",
        apellidos:"",
        id:"",
            ...
            <form onSubmit={saveEmployee}>
              <div className='mb-3'>
                ...
                <input type="text" className='form-control'
                  name="nombres" required autoFocus  onChange={(e)=>handleChange(e)}
                />
              </div>{/*mb-3*/}
              <div className='mb-3'>
              ...
              <div className='mb-3'>
                ...
                <select name="tcontrato" className='form-select'  onChange={(e)=>handleChange(e)}>
                  {
                    tcontratos.map((item)=>(
